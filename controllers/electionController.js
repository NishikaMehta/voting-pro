...
module.exports = {
    createElection, getAllElection, updateElection, deleteElection, getAllElec,getAllElectionName,getTotalNumberOfElections,getElectionDetails,getCandidateDetailsByElectionId,
};
